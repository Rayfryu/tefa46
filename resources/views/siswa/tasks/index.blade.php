...
@section('header')
<div>
    <h1 class="text-2xl font-bold font-display text-slate-900">Task Saya</h1>
    <p class="text-slate-500 text-sm mt-1">Daftar semua task yang di-assign ke kamu</p>
</div>
@endsection
...
<div class="space-y-3">
    ...
    @empty
    <div class="bg-slate-100 border border-surface-700/50 rounded-2xl py-20 text-center">
        ...
        <p class="text-slate-900 font-medium">Belum ada task</p>
        <p class="text-slate-400 text-sm mt-1">Tunggu assignment dari guru atau admin</p>
    </div>
    @endforelse

...
<div>
    ...
    <p class="text-slate-400 text-sm mt-1">Project yang kamu pimpin sebagai PIC</p>
</div>
@endsection
...
<div class="space-y-3">
    ...
    <div class="bg-surface-800 border border-surface-700/50 rounded-2xl p-5
        ...
        <div class="flex flex-col lg:flex-row lg:items-center gap-4">
            ...
            <a href="{{ route('guru.projects.show', $project) }}"
    ...
    <div class="bg-surface-800 border border-surface-700/50 rounded-2xl py-20 text-center">
        ...
        <p class="text-slate-600 text-sm mt-1">Kamu belum ditunjuk sebagai PIC project manapun</p>
    </div>
    @endforelse

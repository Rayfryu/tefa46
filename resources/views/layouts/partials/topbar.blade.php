...
<header class="sticky top-0 z-10 bg-surface-900/80 backdrop-blur-md border-b border-surface-700/50 px-6 py-3">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            ...
            {{-- Notification Bell --}}
            <button
                class="relative p-2 rounded-lg text-slate-400 hover:text-white hover:bg-surface-800 transition-colors">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <div
                        class="w-8 h-8 rounded-full overflow-hidden border border-brand-500/30 bg-surface-800 flex items-center justify-center">
                        ...
                        @else
                            <div
                                class="w-full h-full bg-brand-500/20 flex items-center justify-center
                    text-brand-400 font-bold text-sm font-display">

            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-surface-700/50">
                        ...
                        <th class="text-left px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                            Pengguna</th>
                        <th class="text-left px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider">Role
                        </th>
                        <th class="text-left px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                            Divisi</th>
                        <th class="text-left px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                        ...
                        <th class="text-left px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                            Bergabung</th>
                        <th class="text-right px-6 py-3.5 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                            Aksi</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-surface-700/30">
                        ...
                        <tr class="hover:bg-surface-700/30 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    {{-- Tampilin foto profile user --}}
                                    <div class="w-9 h-9 flex-shrink-0">

                                        @if ($user->image)
                                            <img src="{{ asset('storage/' . $user->image) }}" alt="{{ $user->name }}"
                                                class="w-9 h-9 rounded-full object-cover border border-surface-700">
                                        @else
                                            <div
                                                class="w-9 h-9 rounded-full bg-brand-500/20 border border-brand-500/30
                    flex items-center justify-center text-brand-400 font-bold text-sm font-display">
                            ...
                            <td class="px-6 py-4">
                                @if ($user->is_active)
                                    <span
                                        class="inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-1
